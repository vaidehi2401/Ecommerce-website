    ...
    const steps = [
      ...
      {      
        ...
        options: [   
          {    
            value: "OrderD",   
            label: "I want to check why my order isn't delivered yet😕",        
            trigger: "OrderD",       
          },       
          { value: "ProductN", label: "I am not finding the product I want😓", trigger: "ProductN" },
          { value: "Navailable", label: "The product I want is not available when will it become availaible🤔", trigger: "Navailable" },
          { value: "Recommend", label: "Can you recommend me a product for my need?", trigger: "Recommend" }, 
          { value: "Return", label: "What is your return policy?", trigger: "Return" },
          { value: "Other", label: "I have some other problem.", trigger: "Other" },
      ...
      {       
        id: "OrderD",       
        message:        
          "Yeah Sure, please enter your order number.",        
        trigger:"details",       
      },       
      {       
        id: "Navailable",       
        message:       
          "Please enter which product you want and we will check when it will be available.",       
        trigger:"find",       
      },  
      {
      id: "ProductN",       
        message:       
          "Please enter the details of product you want and we wil check.",       
        trigger:"available"      
      },  
      {
        id: "Recommend",       
          message:       
            "Yeah sure, please enter your product needs and we will suggest you products.",       
          trigger:"recommend1"
        },
        {
          id: "Return",       
            message:       
              "For return policy you can check the orders page and go to the return policy section in it.", 
            end: true
          },      
          {
            id: "Other",       
              message:       
                "Please enter whats your problem and we will help you.", 
              trigger:"other1"      
            },
            {      
              id: "details",      
            ...
            }, 
            {
              id: "order3",       
              message:       
                "I am sorry but this product is not available now 😥. We will reach out to you as soon as it is available.", 
           end:true
            }, 
            {
              id: "order4",       
              message:       
                "According to your information, This product will be available in 2-3 days😁", 
           end:true
            },
            {
              id: "order5",       
              message:       
                "According to the needs you entered, we think that you should checkout our bags section. Some recommended brans are Youva, Zozo", 
           end:true
            },
            {
              id: "order6",       
              message:       
                "To change your password , you should go to settings page and then in the password section you will find change password option", 
           end:true
            }         
    ];
        ...
        <>
            {loading === false &&
                <div>
                            ...
                            <section className="text-center container">
                                <div className="row mt-4 mb-3">
                                    <div className="col-lg-6 col-md-8 mx-auto">
                                        <h1 className="fw-light"> New Category🔥</h1>
                    ...
                    <StyledIcon icon={faComment} onClick={handleClick}/>
                       {showChatbot && <ChatBot className ="chat" steps ={steps} style={myStyle}/>}
